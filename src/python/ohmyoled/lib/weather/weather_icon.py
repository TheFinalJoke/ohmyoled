...
weather_icon_mapping = {
    0: base.WeatherIcon(
        ...
        icon="f00d",
        font="\uf00d",
        time_of_day="Day Conditions Only",
        url=None,
        owmcode=800,
    ),
    1: base.WeatherIcon(
    ...
    5: base.WeatherIcon(
        condition="Light Rain Shower and Flurries",
        icon="f006",
        font="\uf006",
        time_of_day="Day Conditions Only",
        url=None,
    ...
    7: base.WeatherIcon(
        ...
        icon="f013",
        font="\uf013",
        time_of_day="Day and Night Conditions",
        url=None,
        owmcode=801,
    ),
    8: base.WeatherIcon(
    ...
    24: base.WeatherIcon(
        ...
        icon="f02e",
        font="\uf02e",
        time_of_day="Night Conditions Only",
        url=None,
        owmcode=800,
    ),
    25: base.WeatherIcon(
    ...
    39: base.WeatherIcon(
        condition="Thunderstorm with Dust Storm",
        icon="f01e",
        font="\uf01e",
        time_of_day="Day and Night Conditions",
        url=None,
