...
pub fn create_json(dev_mode: bool, existing: Option<Value>) -> Value {
    if dev_mode {
        let dev_json = r#"{
            ...
            "eink": {"enabled":false,"model":"7in5_v2","rotation":0,"threshold":128,"modules":{"time":{"run":true,"color":[255,255,255],"time_format":"12h","timezone":"null"},"weather":{"run":true,"api":"nws","current_location":true,"current_location_api_key":"null","weather_format":"imperial","animation":"subtle"}}}
        }"#;
